...
\begin{frame}
	...
	\begin{itemize}
		\item download \href{https://cran.r-project.org/bin/windows/base/}{\includegraphics[width=0.04\linewidth]{R.png}} and follow the instructions
		\item download \href{https://www.rstudio.com/products/rstudio/download/}{\includegraphics[width=0.10\linewidth]{Rstudio.png}} and follow the instructions
			\item Download \href{https://www.millisecond.com/download/}{\includegraphics[width=0.10\linewidth]{inquisit.png}} and follow the instructions \textcolor{red}{!!! the demo version is valid only for a month!!} \href{https://www.rstudio.com/products/rstudio/download/}{\includegraphics[width=0.10\linewidth]{Rstudio.png}} and follow the instructions 
		...
		\item  \href{http://fisppa.psy.unipd.it/DscoreApp/}{\includegraphics[width=0.10\linewidth]{AppLogo.png}} for analyzing the data (no need to install)
